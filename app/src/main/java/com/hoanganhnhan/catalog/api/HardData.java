...
public class HardData {
    ...
    private List<Promotion> listVouchers;
...
//        Role 0 = client, 1 = admin
    ...
    public List<Promotion> getListVoucher() {
        listVouchers = new ArrayList<>();
        listVouchers.add(new Promotion("MUAVUIVE", "Mua sắm vui vẻ", 100, "12/06/2023"));
        listVouchers.add(new Promotion("MUAHE2023", "Siêu sale hè 2023", 100, "12/06/2023"));
//        listVouchers.add(new Promotion("MUAVUIVE", "Mua sắm vui vẻ", 100, "12/06/2023"));
        return listVouchers;
    }
}
