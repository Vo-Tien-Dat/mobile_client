...
public class data {
    ...
    public List<Laptop> getListProduct(){
        ...
        laptops.add(new Laptop("1","Laptop1","Des1",100.0,100.0,"OS1","CPU","GPU","RAM","Screensolution","HardDisk","Lan1","Wifi1","Communication1","KB1","ScreeSize1","Battery1","Weith1",imageLaptop,"1","1",100));
        laptops.add(new Laptop("1","Laptop1","Des1",100.0,100.0,"OS1","CPU","GPU","RAM","Screensolution","HardDisk","Lan1","Wifi1","Communication1","KB1","ScreeSize1","Battery1","Weith1",imageLaptop,"1","1",100));
        laptops.add(new Laptop("1","Laptop1","Des1",100.0,100.0,"OS1","CPU","GPU","RAM","Screensolution","HardDisk","Lan1","Wifi1","Communication1","KB1","ScreeSize1","Battery1","Weith1",imageLaptop,"1","1",100));
        laptops.add(new Laptop("1","Laptop1","Des1",100.0,100.0,"OS1","CPU","GPU","RAM","Screensolution","HardDisk","Lan1","Wifi1","Communication1","KB1","ScreeSize1","Battery1","Weith1",imageLaptop,"1","1",100));
